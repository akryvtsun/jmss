...
public class Database {
	...
	public static Database createDemoDatabase() {
		List<Member> members = createMembers();
		List<Match> matches = createMatches(members);
		return new Database(members, matches);
	}
	...
	private Database(List<Member> members, List<Match> matches) {
	...
	private static List<Match> createMatches(List<Member> members) {
